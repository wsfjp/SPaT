...
単純な組織の分割(すなわち階層)は、分離した関心事を一つだけ扱えばよい単純な領域であれば、事足ります。しかし、階層的なアプローチは、典型的には開発の取り組みが複数の関心事に跨っているような場合、崩壊してしまいます。このような状況では、より大きく、より複雑な組織単位によって、範囲の経済性で問題を解決しようとする力が働きます。しかし、最も効果的な作業チームは[9 小さなチーム](ch02_09_9_Small_Teams.md)であり、どうにかして仕事を分割する必要があります。
