...
[プロダクトオーナー](ch02_11_11_Product_Owner.md)と[開発チーム](ch02_14_14_Development_Team.md)の役割がそれぞれの仕事に集中することによって、より深い構造的な問題が生じます。価値の最大化（`価値とROI（投資利益率）`を参照）、特定の`スプリントゴール`の達成、または`スプリント`の完了に集中していると、大局を見失いがちです。そのため個人が、自分の関心をチームの利益やプロダクト開発全体の利益から区別することが難しくなります。
